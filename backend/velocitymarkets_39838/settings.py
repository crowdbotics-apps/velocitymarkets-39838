"""
Django settings for velocitymarkets_39838 project.
...
ROOT_URLCONF = 'velocitymarkets_39838.urls'
...
WSGI_APPLICATION = 'velocitymarkets_39838.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "velocitymarkets_39838 API",
    "DESCRIPTION": "API documentation for velocitymarkets_39838 App",
    "VERSION": "v1",
}
